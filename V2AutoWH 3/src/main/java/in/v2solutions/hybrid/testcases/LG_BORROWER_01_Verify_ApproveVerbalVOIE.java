...
public class LG_BORROWER_01_Verify_ApproveVerbalVOIE extends Constants {
String TCName = "LG_BORROWER_01_Verify_ApproveVerbalVOIE";
...
public void verify_ApproveVerbalVOIE(Hashtable<String, String> data)throws Exception {
