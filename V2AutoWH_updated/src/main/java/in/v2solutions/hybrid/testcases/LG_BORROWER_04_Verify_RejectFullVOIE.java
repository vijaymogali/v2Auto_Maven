...
public class LG_BORROWER_04_Verify_RejectFullVOIE extends Constants {
String TCName = "LG_BORROWER_04_Verify_RejectFullVOIE";
...
public void verify_RejectFullVOIE(Hashtable<String, String> data)throws Exception {
